...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public String saveEmployeeInfo(EmployeeRequestDto requestDto) throws HRTDTSException, Exception {
		...
		hrtModel.setHiredate((requestDto.getHiredate() != null && !requestDto.getHiredate().isEmpty())
		...
		hrtModel.setNextReviewDate((requestDto.getNextReviewDate() != null && !requestDto.getNextReviewDate().isEmpty())
		...
		hrtModel.setDob(((requestDto.getDob() != null && !requestDto.getDob().isEmpty()))
	...
	public EmployeeResponseDto getUserHrtInfo(long id)  throws HRTDTSException, Exception {
		...
		if (hrtModel != null) {
			...
			responseDto.setEmployeeType(
					(hrtModel.getEmployeeType() != null) ? hrtModel.getEmployeeType().getValue() : null);
			...
			responseDto.setMaritalStatus(
					(hrtModel.getMaritalStatus() != null) ? hrtModel.getMaritalStatus().getValue() : null);
			responseDto.setRace((hrtModel.getRace() != null) ? hrtModel.getRace().getValue() : null);
			responseDto.setDepartment(
					(hrtModel.getDepartment() != null) ? hrtModel.getDepartment().getDepartmentId() : null);
			...
			responseDto.setTerminationType(
					(hrtModel.getTerminationType() != null) ? hrtModel.getTerminationType().getId() : null);
			responseDto.setEmployeeContractors(
					(hrtModel.getEmployeeContractors() != null) ? hrtModel.getEmployeeContractors().getContractorId()
							: null);
			responseDto.setEmployeeStatus(
					(hrtModel.getEmployeeStatus() != null) ? hrtModel.getEmployeeStatus().getId() : null);
